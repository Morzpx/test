...
local GenerateButtonList = function()
    ...
    CreateButton(
            ...
            function(self)
                ...
                EncounterJournal_DisplayInstance(1208) -- Aberrus
    ...
    CreateButton(
            ...
            function(self)
                ...
                ShowContentWidget(_EchoRaidTools:GetDocumentationWidget(), "Documentation")
            end
    )]]
    ...
    for index, button in ipairs(_EchoRaidTools.moduleButtons or {}) do
        if index == 1 then
            ...
            button:SetPoint("TOPLEFT", _EchoRaidTools.panels.main.MainMenu.ScrollFrame.Content, "TOPLEFT", 5, -5)
            button:SetPoint("BOTTOMRIGHT", _EchoRaidTools.panels.main.MainMenu.ScrollFrame.Content, "TOPRIGHT", 0, -35)
            button:Show()
        else
            button:ClearAllPoints()
