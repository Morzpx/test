...
--
	...
	function ZGV_DefaultSkin_DefaultStep_Mixin:Render()
		...
		-- header?:
			...
			local prereqtext = ZGV.QuestDB:GetStepTag(stepdata)

			if (numbertext or leveltext or reqtext or titletext or betatext or prereqtext) then
				lineframe = self:NextLine()
				lineframe:ShowAsHeader((numbertext or "")..(leveltext or "")..(reqtext or "")..(titletext or "")..(betatext or "")..(prereqtext or ""))
			end
		--
