...
function ZGV.CreateFrameWithBG(type,name,parent,template)
	return CreateFrame(type, name, parent, template or (BackdropTemplateMixin and "BackdropTemplate"))
end
...
function ZGV.F.GetCurrentPath()
	local stack = debugstack(0)
	DDIR=stack
end
...
if false then  -- unit test CreateSprite
	local t = Zygor_SpriteTexture_Mixin:CreateSprite(4,40,50,110,110,true)
	assert(t and t[1] and t[1][1] and t[1][2] and t[1][1]==0 and abs(t[1][2]-0.3636)<0.001)
	assert(t and t[4] and t[4][3] and t[4][4] and abs(t[4][3]-0.4545)<0.001 and abs(t[4][4]-0.9090)<0.001)
	assert(t and t[5] and t[5][1]==t[3][2] and t[5][2]==t[3][1] and t[5][3]==t[3][3] and t[5][4]==t[3][4])  --flip?
end
