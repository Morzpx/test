...
Enter The Stockade dungeon with your group |goto 39.79,54.22 < 10 |c
step
...
Enter the building |goto 77.14,58.04 < 7 |walk
talk Master Mathias Shaw##332
|tip Upstairs inside the building.
turnin The Defias Brotherhood##135 |goto 75.78,59.84
accept The Defias Brotherhood##141 |goto 75.78,59.84
step
...
talk Wilder Thistlenettle##656
|tip Inside the building
turnin Oh Brother...##167 |goto 65.45,21.21
turnin Collecting Memories##168 |goto 65.45,21.21
]])
...
accept The Unsent Letter##373
step
Enter the building |goto 47.89,31.17 < 5 |walk
talk Baros Alexston##1646
turnin The Unsent Letter##373 |goto 49.20,30.28
accept Bazil Thredd##389 |goto 49.20,30.28
step
Enter the building |goto 42.20,58.77 < 5 |walk
talk Warden Thelwater##1719
|tip Inside the building.
turnin Bazil Thredd##389 |goto 41.10,58.09
accept The Stockade Riots##391 |goto 41.10,58.09
accept Quell The Uprising##387 |goto 41.10,58.09
step
Enter The Stockade dungeon with your group |goto 39.80,54.24 < 7 |c |q 378
...
turnin Quell The Uprising##387 |goto 41.10,58.09
step
...
|tip Inside the building.
accept Brother Anton##6141 |goto 42.58,24.23
step
...
|tip Inside the building.
turnin The True Masters##4183 |goto 29.99,44.45
accept The True Masters##4184 |goto 29.99,44.45
step
...
talk Magistrate Solomon##344
|tip Inside the building.
turnin The True Masters##4186 |goto 29.99,44.45
accept The True Masters##4223 |goto 29.99,44.45
step
Follow the path up |goto Burning Steppes 82.76,63.28 < 10 |only if walking
...
step
Follow the path up |goto 82.76,63.28 < 10 |only if walking
talk Marshal Maxwell##9560
...
|tip Inside the building.
buy 2 Rune Thread##14341 |goto 43.25,74.08 |q 5518 |future
step
...
|tip Inside the building.
accept Mayara Brightwing##4766 |goto 74.00,30.22
step
...
step
collect 5 Arcane Crystal##12363 |q 9121/1 |only if havequest(9121) or completedq(9121)
collect 3 Arcane Crystal##12363 |q 9122/1 |only if havequest(9122) or completedq(9122)
|tip Farm them from Rich Thorium Veins with Mining or purchase them from the Auction House.
step
label "Collect_Nexus_Crystals"
collect 2 Nexus Crystal##20725 |q 9121/2 |only if havequest(9121) or completedq(9121)
collect 1 Nexus Crystal##20725 |q 9122/2 |only if havequest(9122) or completedq(9122)
