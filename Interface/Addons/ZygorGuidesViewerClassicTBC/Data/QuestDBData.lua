ZGV.Quest_Cache_Accept_Alliance = {
	...
	["PROFESSIONS\\Blacksmithing\\Blacksmithing (1-375)"] = {
		{ids="10655,10653,10654,10421", cond_if=[[completedq(10551) ]]},
		{ids="10659,10656,10658,10419", cond_if=[[completedq(10552) ]]},
		{ids="7652,7655,7654,7656,10210,10211"},
	},
	...
	["LEVELING\\Classic (12-58)\\Stranglethorn Vale (32-33)"] = {
		...
		{ids="210,583,194,185,190,186,187,191,192,195,627,622,616"},
	},
	...
	["LEVELING\\Classic (12-58)\\Darkshore (23-24)"] = {
		{ids="741,986,10752,2098,2078,993,994,995,990,942"},
	},
	["LEVELING\\Classic (12-58)\\Searing Gorge (50-51)"] = {
		{ids="4449,3367,3368,3441,3442,7701,7728,7729,7723,7724,7727,7722,3371,4451,3443,3452,3377,3378,3453,3454,3462,3463,3481,3790,4512,3448,3449,3450,3451"},
	},
	["LEVELING\\Classic (12-58)\\Burning Steppes (55-56)"] = {
		{ids="3702,3701,3823,4283,4726,4296,4022,4808"},
	},
	["LEVELING\\Classic (12-58)\\Loch Modan (17-18)"] = {
		{ids="1338", cond_if=[[NightElf or Draenei ]]},
		{ids="5061", cond_if=[[NightElf Druid ]]},
		{ids="436,297,298,385,257,258,2038,250,199,301,2041,6661,6662"},
	},
	...
	["LEVELING\\Classic (12-58)\\The Hinterlands (47-48)"] = {
		{ids="1450,1451,2988,2877,2880,9469,9470,9471,9476,9475"},
	},
	["LEVELING\\Classic (12-58)\\Darkshore (20-20)"] = {
		{ids="1133,4740,944,949,950,945,731,4733,4732,4731,4730,951,5321,5713,970"},
		{ids="9501,9503,9504", cond_if=[[Shaman ]]},
	},
	["LEVELING\\Classic (12-58)\\Tanaris (49-50)"] = {
		{ids="82,3362,4504,5863,2605,3444,3161,1560,4324,2606,10,110,113,162,4502"},
	},
	["LEVELING\\Classic (12-58)\\Tanaris (45-46)"] = {
		{ids="626,992,2781,2875,3022,1707,1690,1188,1190,1194,8365,3520,8366,2873,1691,2874"},
	},
	["LEVELING\\Classic (12-58)\\Winterspring (57-58)"] = {
		{ids="5083", cond_if=[[itemcount(12771) > 0 ]]},
		{ids="8464,4842,5082,5244,4861,3783,4809,4863,4864,977"},
	},
	["LEVELING\\Classic (12-58)\\Duskwood (28-29)"] = {
		{ids="1718", cond_if=[[Warrior ]]},
		{ids="66,101,56,173,163,165,164,174,175,177,57,221,181,222,148,225,95,58,227,223,149,154,157,230,158,262,265,266"},
	},
	["LEVELING\\Classic (12-58)\\Ashenvale (20-22)"] = {
		{ids="1010,1020,973,1008,1070,1056,991,1054,1033,1023,1007,1009,1024,1025,1134,1026,1034"},
	},
	["LEVELING\\Boosted Characters\\Boosted Warlock Intro"] = {
		{ids="64028,64031,64034,64035,64038,10119"},
	},
	["LEVELING\\Starter Guides (1-12)\\Azuremyst Isle (1-12) [Draenei Starter]"] = {
		...
		{ids="8329,9582,10350", cond_if=[[Draenei Warrior ]]},
		{ids="9409,9371,10302,9293,9799,9294,10304,9305,9303,9309,10303,9311,9798,9312,9313,9314,9452,9453,9454,9506,9512,9513,9523,9530,9531,9514,10324,9455,10428,9456,9537,9515,9602,9538,9539,9540,9541,9542,9544,9527,9559,9560,9562,9616,9564,9565,9573,9566,9570,9571,9622,9623"},
	},
	...
	["LEVELING\\Classic (12-58)\\Badlands (42-43)"] = {
		{ids="2500,738,719,718,720,733,703,705,1108,739,1137,710,713,714,715,711,712,734,777,716,778,603"},
	},
	["LEVELING\\Classic (12-58)\\Darkshore (12-17)"] = {
		{ids="6121,6122,6123,6124,6125,26,29,272", cond_if=[[NightElf Druid ]]},
		{ids="963,983,3524,947,4811,954,958,2118,984,1001,4681,4723,1002,955,956,957,953,4812,2138,985,4761,965,4762,4725,1003,4727,2139,4763,729,1138,4813,4722,4728,966,967,948"},
	},
	["LEVELING\\The Burning Crusade (58-70)\\Hellfire Peninsula (58-61)"] = {
	...
	["LEVELING\\Classic (12-58)\\Western Plaguelands (56-57)"] = {
		{ids="5092,5401,5215,5097,5216,5217,5021,5022,5219,5220,5058,5060,5060,5048,5050,5222,5223,4984,5051,4985,4986"},
	},
	...
	["LEVELING\\Classic (12-58)\\Ashenvale (29-31)"] = {
		{ids="9552,9553,9554", cond_if=[[Shaman ]]},
		{ids="1719", cond_if=[[Warrior ]]},
		{ids="9533,1011,9519,9518,9516,1021,9517,9526,1031,1032,9520"},
	},
	["LEVELING\\Classic (12-58)\\Desolace (34-35)"] = {
		{ids="1437,1382,1387,1454,1458,1465,1438,1459,5501,5561,1455,6161,5741,1439,1440,6027"},
	},
	...
	["LEVELING\\Extra Zones\\Eastern Plaguelands"] = {
		{ids="5542,5543,5544,5149,5152,5241,6021,5281,5211,6026,9141,5237,5903,6164,5742,5781,5845,9136,9126,9124,9131,5097,6186,5904,5846"},
	},
	["LEVELING\\Classic (12-58)\\Ashenvale (24-25)"] = {
		{ids="4581,1035,1140,1016"},
	},
	...
	["LEVELING\\Classic (12-58)\\Stranglethorn Vale (43-45)"] = {
		{ids="338,340", cond_if=[[((itemcount(2734) >= 1) and (itemcount(2735) >= 1) and (itemcount(2738) >= 1) and (itemcount(2740) >= 1) and (not completedq(340))) ]]},
		{ids="338,341", cond_if=[[((itemcount(2742) >= 1) and (itemcount(2744) >= 1) and (itemcount(2745) >= 1) and (itemcount(2748) >= 1) and (not completedq(341))) ]]},
		{ids="338,339", cond_if=[[((itemcount(2725) >= 1) and (itemcount(2728) >= 1) and (itemcount(2730) >= 1) and (itemcount(2732) >= 1) and (not completedq(339))) ]]},
		{ids="338,342", cond_if=[[((itemcount(2749) >= 1) and (itemcount(2750) >= 1) and (itemcount(2751) >= 1) and (not completedq(342))) ]]},
		{ids="600,621,610,587,2864,209,604,617,609,2872,576,611,580,608,623,594,630,624"},
	},
	["LEVELING\\Classic (12-58)\\Redridge Mountains (27-28)"] = {
		{ids="128,20,91,180,34,219"},
	},
	["LEVELING\\Boosted Characters\\Boosted Druid Intro"] = {
		{ids="64028,64031,64034,64035,64038,10119"},
	},
	["LEVELING\\Cenarion Field Duty Logistics Assignments"] = {
		{ids="8780", cond_if=[[itemcount(21263) >= 1 or havequest(8780) ]]},
		{ids="8779", cond_if=[[itemcount(21259) >= 1 or havequest(8779) ]]},
		{ids="8496", cond_if=[[itemcount(20806) >= 1 or havequest(8496) ]]},
		{ids="8541", cond_if=[[itemcount(20940) >= 1 or havequest(8541) ]]},
		{ids="8497", cond_if=[[itemcount(20807) >= 1 or havequest(8497) ]]},
		{ids="8783", cond_if=[[itemcount(21265) >= 1 or havequest(8783) ]]},
		{ids="8805", cond_if=[[itemcount(20939) >= 1 or havequest(8805) ]]},
		{ids="8782", cond_if=[[itemcount(21262) >= 1 or havequest(8782) ]]},
		{ids="8829", cond_if=[[itemcount(21514) >= 1 or havequest(8829) ]]},
		{ids="8781", cond_if=[[itemcount(21260) >= 1 or havequest(8781) ]]},
		{ids="8778", cond_if=[[itemcount(21257) >= 1 or havequest(8778) ]]},
		{ids="8507,8508"},
	},
	["LEVELING\\Classic (12-58)\\Hillsbrad Foothills (37-37)"] = {
		{ids="707,555,500,505,510,511,514,512,659"},
	},
	["LEVELING\\Classic (12-58)\\Stranglethorn Vale (42-42)"] = {
		{ids="338,340", cond_if=[[((itemcount(2734) >= 1) and (itemcount(2735) >= 1) and (itemcount(2738) >= 1) and (itemcount(2740) >= 1) and (not completedq(340))) ]]},
		{ids="338,341", cond_if=[[((itemcount(2742) >= 1) and (itemcount(2744) >= 1) and (itemcount(2745) >= 1) and (itemcount(2748) >= 1) and (not completedq(341))) ]]},
		{ids="338,339", cond_if=[[((itemcount(2725) >= 1) and (itemcount(2728) >= 1) and (itemcount(2730) >= 1) and (itemcount(2732) >= 1) and (not completedq(339))) ]]},
		{ids="338,342", cond_if=[[((itemcount(2749) >= 1) and (itemcount(2750) >= 1) and (itemcount(2751) >= 1) and (not completedq(342))) ]]},
		{ids="595,606,597,197,628,599,602,607"},
	},
	["LEVELING\\Classic (12-58)\\Wetlands (25-27)"] = {
		{ids="2360,2359,2607,2608", cond_if=[[Rogue ]]},
		{ids="279,288,463,943,289,470,464,484,305,294,306,295,299,296,469,276,277,275,281,471,465,284,285,286,290"},
	},
	["LEVELING\\Classic (12-58)\\Wetlands (31-31)"] = {
		{ids="292,474,293,472,631,632,633,634"},
	},
	["LEVELING\\Extra Zones\\Western Plaguelands"] = {
		{ids="4513,5092,5401,1019,5215,5216,5217,5021,5022,5048,5050,6182,6183,6184,5219,6185,5051,5220,5058,5060,5060,5222,5223,4984,4985,4986,5225,5226,5153,5154,4971,4972,5210,6389,6004,6023,5533,5537,8275,4902,6761,6762,1124,4442"},
	},
	...
	["LEVELING\\Classic (12-58)\\Arathi Highlands (37-39)"] = {
		{ids="691,642,651,693,663,662,664,665,666,668,669,1302,1114,1106,1115,1186,1187"},
	},
	["LEVELING\\Classic (12-58)\\Felwood (57-57)"] = {
		{ids="5165,8461,8465"},
	},
	...
	["LEVELING\\Extra Zones\\Silithus"] = {
		{ids="1125,8280,8283,8277,8284,8318,8304,9415,1126,8308,6844,8281,8278,8282,8285,8306,8279,8287,8323,5181,9128,6845,1185,8320,8361,8321"},
	},
	...
	["LEVELING\\Classic (12-58)\\Stonetalon Mountains (22-23)"] = {
		{ids="9508,9509", cond_if=[[Shaman ]]},
		{ids="1093,1085,1071,1072,1075"},
	},
	["LEVELING\\The Burning Crusade (58-70)\\Zangarmarsh (61-63)"] = {
		...
		{ids="9747,9802,9728,9895,9716,9778,9728,9782,9786,9901,9777,9781,9791,9827,9783,9896,10355,9780,9776,9752,9788,10096,9894,9718,9720,9790,9731,9848,10116,9835,10115,9839,9834,9830,9833,9902,9785,9724,9732,9911,9701,9739,9743,9919,9702,9708,9808,9806,9905,9787,9709,9801,9803,9793"},
	},
	...
	["LEVELING\\Warlock Class Quests"] = {
		...
		{ids="1717,1716,1738,1739,1798,1758,1802,1804,1471,4487,4490,7601,7602,8420,8421,8422,7603,7562,7563,7564,7623,7626,7627,7628,7630,7624,7625,7629,7631", cond_if=[[Warlock ]]},
		{ids="1599,1715,1688,1689", cond_if=[[Gnome Warlock ]]},
	},
	["LEVELING\\Classic (12-58)\\Feralas (48-49)"] = {
		{ids="7735", cond_if=[[itemcount(18969) > 0 ]]},
		{ids="2943,7733,2879,3445,7003,7721,7725,2844,2942,2845"},
	},
	["LEVELING\\Boosted Characters\\Boosted Priest Intro"] = {
		{ids="64028,64031,64034,64035,64038,10119"},
	},
	["LEVELING\\Starter Guides (1-12)\\Teldrassil (1-12) [Night Elf Starter]"] = {
		{ids="6063,6101,6102,6103", cond_if=[[NightElf Hunter ]]},
		{ids="3118", cond=[[NightElf Rogue]]},
		{ids="3117", cond=[[NightElf Hunter]]},
		{ids="5923,5921,5929,5931,6001", cond_if=[[NightElf Druid ]]},
		{ids="5629", cond_if=[[NightElf Priest ]]},
		{ids="6344,6341,6342,6343", cond_if=[[NightElf ]]},
		{ids="3119", cond=[[NightElf Priest]]},
		{ids="3120", cond=[[NightElf Druid]]},
		{ids="3116", cond=[[NightElf Warrior]]},
		{ids="456,4495,458,457,459,916,3519,917,3521,920,921,3522,928,2159,488,489,997,475,932,2438,929,476,483,2459,933,918,919,922,487,2541,2561,486,930,7383,937,931,940,935,923,952,2519,2518,938,2498,2520,2499"},
	},
	...
	["LEVELING\\Classic (12-58)\\Hillsbrad Foothills (31-32)"] = {
		{ids="564,536,559,560,9435,561,562,563,681,1453,1179,690"},
	},
	["LEVELING\\Starter Guides (1-12)\\Dun Morogh (1-12) [Dwarf & Gnome Starter]"] = {
		...
		{ids="3115", cond=[[Gnome Warlock]]},
		{ids="3108", cond=[[Dwarf Hunter]]},
		{ids="5635,6661,6662", cond_if=[[Dwarf Priest ]]},
		...
		{ids="179,233,170,3361,234,183,3364,3365,182,218,282,420,2160,384,400,317,313,5541,287,318,412,312,319,315,310,308,311,320,413,291,433,432,419,417,414,224,267,416,1339,418,1338,307"},
	},
	["LEVELING\\Boosted Characters\\Boosted Paladin Intro"] = {
		{ids="64028,64031,64034,64035,64038,10119"},
	},
	["LEVELING\\Classic (12-58)\\Azshara (52-52)"] = {
		{ids="5535,5536,3601,5534,3461"},
	},
	...
	["LEVELING\\Classic (12-58)\\Felwood (52-53)"] = {
		{ids="4101,8460,8462,5155,4421,5156,5157,4906,5249,939,5158,4441,5882"},
	},
	["LEVELING\\Cenarion Field Duty Combat Assignments"] = {
		{ids="8539", cond_if=[[itemcount(21249) >= 1 or havequest(8539) ]]},
		{ids="8501", cond_if=[[itemcount(20941) >= 1 or havequest(8501) ]]},
		{ids="8777", cond_if=[[itemcount(21256) >= 1 or havequest(8777) ]]},
		{ids="8776", cond_if=[[itemcount(21255) >= 1 or havequest(8776) ]]},
		{ids="8775", cond_if=[[itemcount(21253) >= 1 or havequest(8775) ]]},
		{ids="8770", cond_if=[[itemcount(21749) >= 1 or havequest(8770) ]]},
		{ids="8774", cond_if=[[itemcount(21252) >= 1 or havequest(8774) ]]},
		{ids="8687", cond_if=[[itemcount(21251) >= 1 or havequest(8687) ]]},
		{ids="8502", cond_if=[[itemcount(20942) >= 1 or havequest(8502) ]]},
		{ids="8772", cond_if=[[itemcount(21250) >= 1 or havequest(8772) ]]},
		{ids="8771", cond_if=[[itemcount(21750) >= 1 or havequest(8771) ]]},
		{ids="8773", cond_if=[[itemcount(21248) >= 1 or havequest(8773) ]]},
		{ids="8507,8508"},
	},
	...
	["LEVELING\\Extra Zones\\Bloodmyst Isle"] = {
		{ids="9667", cond_if=[[completedq(9544) ]]},
		{ids="9603,9604,9605,9606", cond_if=[[Draenei ]]},
		{ids="9625,9624,9634,9663,9666,9629,9629,9693,9581,9694,9648,9668,9576,9567,9574,9620,9641,10063,9628,9584,9643,9580,9594,9569,9578,9585,9779,9647,9649,9548,9549,9550,10064,9696,9698,9669,9671,9672,9557,9687,9688,9674,9682,9683,9561,9699,9700,9703,9579,9706,9711,9748,10065,9741,10067,10066,9670,9746,9753,9756,9760,9740,9632,9633"},
	},
	...
	["LEVELING\\Classic (12-58)\\Un'Goro Crater (53-55)"] = {
		{ids="3884", cond_if=[[itemcount(11116) > 0 ]]},
		{ids="978,4493,4496,4289,4290,4243,4503,4141,4501,3882,3883,3881,4244,4245,4291,4301,3844,3845,4292,974,4492,4284,4285,4287,4288,3908,4491,980,4321,5159,4442,5091,3764,3781"},
	},
	["LEVELING\\Classic (12-58)\\Blasted Lands (51-52)"] = {
		{ids="3501", cond_if=[[itemcount(10593) > 0 ]]},
		{ids="2783,2801,2581,2583,2585,2601,2603"},
	},
	["LEVELING\\Classic (12-58)\\Thousand Needles (33-34)"] = {
		{ids="1100,1110,1111,5762,1104,1105,1176,1175,1178,1260"},
	},
	["LEVELING\\Classic (12-58)\\Dustwallow Marsh (39-42)"] = {
		{ids="11191,11126,1282,11212,1204,11214,11123,11128,11133,11134,11192,11193,11194,11209,11210,11198,11177,11136,11137,1218,11180,1219,1206,11181,11183,11146,1222,1177,1284,1252,1253,11184,11158,11217,1220,1259,1319,1285,1286,1320,11138,1203,11139,11140,11141,1287,11160,11161,11143,11142,11145,11147,11144,11148,11149,11159,11156,11172,11150,11173,11185,11174,11207,11208,11151,11162,11152"},
	},
	["LEVELING\\Starter Guides (1-12)\\Elwynn Forest (1-13) [Human Starter]"] = {
		...
		{ids="783,7,5261,33,15,18,3903,6,21,3904,3905,54,2158,62,60,47,106,111,85,107,86,84,87,61,112,40,35,76,37,52,83,5545,45,71,39,114,59,239,46,1097,11,353,6661,433,432,419,417,224,267,416,418,307"},
	},
	["LEVELING\\Classic (12-58)\\Swamp of Sorrows (45-45)"] = {
		{ids="1448,625,9610,1392,1395,1449"},
	},
	["LEVELING\\Classic (12-58)\\Stranglethorn Vale (35-37)"] = {
		{ids="338,340,338,340", cond_if=[[((itemcount(2734) >= 1) and (itemcount(2735) >= 1) and (itemcount(2738) >= 1) and (itemcount(2740) >= 1) and (not completedq(340))) ]]},
		{ids="338,341,338,341", cond_if=[[((itemcount(2742) >= 1) and (itemcount(2744) >= 1) and (itemcount(2745) >= 1) and (itemcount(2748) >= 1) and (not completedq(341))) ]]},
		{ids="338,339,338,339", cond_if=[[((itemcount(2725) >= 1) and (itemcount(2728) >= 1) and (itemcount(2730) >= 1) and (itemcount(2732) >= 1) and (not completedq(339))) ]]},
		{ids="338,342,338,342", cond_if=[[((itemcount(2749) >= 1) and (itemcount(2750) >= 1) and (itemcount(2751) >= 1) and (not completedq(342))) ]]},
		{ids="1180,1112,1181,605,201,198,189,213,1182,578,575,203,204,215,200,328,574,329,330,331,196,188,193,1183,601,577"},
	},
	["LEVELING\\Classic (12-58)\\Feralas (46-47)"] = {
		{ids="2821,4124,2866,2939,2982,4125,2867,3130,2869,2870,4127,4129,2871,4130,4131,2969,2970,2972,4135,4281,4265,4266,4267,2940,2941,3661,2944,2741"},
	},
	["LEVELING\\Cenarion Field Duty Tactical Assignments"] = {
		{ids="8498", cond_if=[[itemcount(20943) >= 1 or havequest(8498) ]]},
		{ids="8737", cond_if=[[itemcount(21245) >= 1 or havequest(8737) ]]},
		{ids="8740", cond_if=[[itemcount(20944) >= 1 or havequest(8740) ]]},
		{ids="8739", cond_if=[[itemcount(21167) >= 1 or havequest(8739) ]]},
		{ids="8537", cond_if=[[itemcount(20945) >= 1 or havequest(8537) ]]},
		{ids="8538", cond_if=[[itemcount(20948) >= 1 or havequest(8538) ]]},
		{ids="8535", cond_if=[[itemcount(20947) >= 1 or havequest(8535) ]]},
		{ids="8738", cond_if=[[itemcount(21166) >= 1 or havequest(8738) ]]},
		{ids="8536", cond_if=[[itemcount(21751) >= 1 or havequest(8536) ]]},
		{ids="8534", cond_if=[[itemcount(21165) >= 1 or havequest(8534) ]]},
		{ids="8507,8508"},
	},
	["LEVELING\\Classic (12-58)\\Redridge Mountains (18-20)"] = {
		{ids="1717,1716,1738,1739", cond_if=[[Warlock ]]},
		{ids="244,246,20,125,3741,127,129,92,89,130,131,150"},
	},
	...
	["DUNGEONS\\The Burning Crusade\\Shattered Halls Quests"] = {
		{ids="9492,9492", cond_if=[[Alliance ]]},
	},
	...
	["DUNGEONS\\The Burning Crusade\\Old Hillsbrad Foothills Quests"] = {
		{ids="10279,10277,10282,10283,10284,10285"},
	},
	...
	["DUNGEONS\\The Burning Crusade\\Shadow Labyrinth Quests"] = {
		...
		{ids="10641,10668,10669,10646,10649,10621,10626,10662,10664,10666,11216,9824,9825,9826,9829,9831,10177,10094,10178,10091,10095"},
	},
	...
	["DUNGEONS\\Classic\\Temple of Atal'Hakkar Quests"] = {
		{ids="1448,1449,1450,1451,1452,1469,1475,3445,3444,3446,3520,3527,4787,1446,3528,4141,4142,4143,3447,3373"},
	},
	["DUNGEONS\\Classic\\Scarlet Monastery Armory Quests"] = {
		{ids="6141,261,1052,1053"},
	},
	["DUNGEONS\\The Burning Crusade\\The Arcatraz Quests"] = {
		{ids="10265,10262,10205,10266,10267,10268,10269,10275,10276,10280,10704"},
	},
...
ZGV.Quest_Cache_Turnin_Alliance = {
	...
	["PROFESSIONS\\Blacksmithing\\Blacksmithing (1-375)"] = {
		{ids="7655,7654,7656,10210,10211"},
	},
	["PROFESSIONS\\Fishing\\Fishing (1-300)"] = {
		{ids="6607"},
	},
	...
	["LEVELING\\Classic (12-58)\\Stranglethorn Vale (32-33)"] = {
		...
		{ids="583,185,186,190,191,194,210,627,616"},
	},
	["LEVELING\\Ahn'Qiraj Gear\\Ruins of Ahn'Qiraj Ring Quest"] = {
		{ids="8556", cond=[[Warrior]]},
		{ids="8703", cond=[[Paladin]]},
	...
	["LEVELING\\Classic (12-58)\\Darkshore (23-24)"] = {
		...
		{ids="4730,4731,4732,4733,4740,731,2098,2078,986,951,993,741"},
	},
	["LEVELING\\Classic (12-58)\\Searing Gorge (50-51)"] = {
		{ids="3367,4449,3441,3368,3442,3371,3443,7701,7723,7724,7727,7728,7729,7722,3377,3452,3453,3454,3462,4451,3463,3481,3448,3450,3451"},
	},
	["LEVELING\\Classic (12-58)\\Burning Steppes (55-56)"] = {
		{ids="3702,3461,4512,4324,4022,4726,4296,3823,4283"},
	},
	["LEVELING\\Classic (12-58)\\Loch Modan (17-18)"] = {
	...
	["LEVELING\\Classic (12-58)\\The Hinterlands (47-48)"] = {
		{ids="1449,1450,9469,1451,9476,626,2877,2880,9470,9471,9475,2988"},
	},
	["LEVELING\\Classic (12-58)\\Darkshore (20-20)"] = {
		{ids="948,944,949,729,950,5321,5713,967"},
		{ids="9501,9503", cond_if=[[Shaman ]]},
	},
	["LEVELING\\Classic (12-58)\\Tanaris (49-50)"] = {
		{ids="3445,1560,3520,2605,2606,82,3362,5863,3161,10,110,113,2874,580"},
	},
	["LEVELING\\Classic (12-58)\\Tanaris (45-46)"] = {
		{ids="623,625,2864,1137,1187,1190,1194,1188,2872,1707,2781,1690,992,8365,2875,8366,2873,1691"},
	},
	["LEVELING\\Classic (12-58)\\Winterspring (57-58)"] = {
		{ids="8465,980,3908,5249,5244,4808,4861,4863,3783,4809,977,4864,4842,5083,5082,8464,978"},
	},
	["LEVELING\\Classic (12-58)\\Duskwood (28-29)"] = {
		{ids="66,174,175,56,173,177,221,163,165,164,57,225,227,222,223,101,148,181,149,154,95,157,230,158,58,262,265,266"},
	},
	["LEVELING\\Classic (12-58)\\Ashenvale (20-22)"] = {
		{ids="1010,970,945,1133,1020,991,1007,1009,1023,1008,1024,1033,1025"},
	},
	["LEVELING\\Boosted Characters\\Boosted Warlock Intro"] = {
	...
	["LEVELING\\Starter Guides (1-12)\\Azuremyst Isle (1-12) [Draenei Starter]"] = {
		{ids="9586", cond_if=[[Draenei Priest ]]},
		{ids="9283", cond_if=[[havequest(9283) or completedq(9283) ]]},
		{ids="9757,9591,9592,9593,9675", cond_if=[[Draenei Hunter ]]},
		{ids="9283,9449,9450,9451,9462,9464,9465,9467,9468,9461,9555", cond_if=[[Draenei Shaman ]]},
		{ids="9473", cond_if=[[havequest(9473) or completedq(9473) ]]},
		{ids="9369", cond_if=[[havequest(9369) or completedq(9369) ]]},
		{ids="9280", cond_if=[[havequest(9280) or completedq(9280) ]]},
		{ids="9582,10350", cond_if=[[Draenei Warrior ]]},
		{ids="9595", cond_if=[[Draenei Mage ]]},
		{ids="10366,9598,9600", cond_if=[[Draenei Paladin ]]},
		{ids="9463", cond_if=[[havequest(9463) or completedq(9463) ]]},
		{ids="9616", cond_if=[[havequest(9616) or completedq(9616) ]]},
		{ids="9409,9371,10302,9799,9293,9294,10304,9305,9303,9309,10303,9311,9798,9312,9452,9453,9313,9314,9512,9506,9530,9454,10324,9455,9456,9531,9513,9514,9523,9537,9602,9538,9539,9540,9541,9542,10428,9527,9544,9515,9559,9560,9564,9562,9565,9566,9573,9570,9571,9622,9623"},
		{ids="9279", cond_if=[[havequest(9279) or completedq(9279) ]]},
	},
	["LEVELING\\The Burning Crusade (58-70)\\Shadowmoon Valley (70-70)"] = {
	...
	["LEVELING\\Classic (12-58)\\Badlands (42-43)"] = {
		{ids="707,720,719,718,705,1106,738,1108,713,714,715,710,711,712,734,716,777,778,703,733,2500,739,602"},
	},
	["LEVELING\\Classic (12-58)\\Darkshore (12-17)"] = {
		{ids="952", cond_if=[[NightElf ]]},
		{ids="6121,6122,6123,6124,6125,26,29", cond_if=[[NightElf Druid ]]},
		{ids="983,3524,4681,1001,954,955,956,953,963,4723,4811,2118,984,958,4761,957,1002,2138,4762,4725,4727,4812,1003,4722,4728,4813,985,965,966,2139,4763,947,1138"},
	},
	["LEVELING\\The Burning Crusade (58-70)\\Hellfire Peninsula (58-61)"] = {
	...
	["LEVELING\\Classic (12-58)\\Western Plaguelands (56-57)"] = {
		{ids="3701,5091,5092,5215,5216,5021,5217,5097,5219,5022,5048,5220,5222,5050,5051,4984,4985,5223"},
	},
	["LEVELING\\Mage Class Quests"] = {
	...
	["LEVELING\\Classic (12-58)\\Ashenvale (29-31)"] = {
		{ids="9520", cond_if=[[havequest(9520) or completedq(9520) ]]},
		{ids="9552,9553,9554", cond_if=[[Shaman ]]},
		{ids="1718,1719", cond_if=[[Warrior ]]},
		{ids="1026,4581,9533,1021,1031,9519,1032,1011,9518,9516,9517,9526,1035,1140"},
	},
	["LEVELING\\Classic (12-58)\\Desolace (34-35)"] = {
		{ids="1453,1437,1465,1458,5561,1382,1459,1387,5501,1454,1438,1439,5741,6161,6027,1455,1440"},
	},
	["LEVELING\\Ahn'Qiraj Gear\\Ruins of Ahn'Qiraj Weapon Quest"] = {
		{ids="8558", cond=[[Warrior]]},
		{ids="8711", cond=[[Paladin]]},
	...
	["LEVELING\\Extra Zones\\Eastern Plaguelands"] = {
		{ids="5601,5149,6030,5241,6026,9141,5226,6185,5245,5281,6164,5542,5543,5544,5742,5781,6021,5211,9136,9126,9124,9131,5903,5845"},
	},
	["LEVELING\\Classic (12-58)\\Ashenvale (24-25)"] = {
		{ids="1134,990,10752,1034,973,1054,1016"},
	},
	["LEVELING\\Ahn'Qiraj Gear\\Temple of Ahn'Qiraj Boots Quest"] = {
		{ids="8559", cond=[[Warrior]]},
		{ids="8655", cond=[[Paladin]]},
	...
	["LEVELING\\Classic (12-58)\\Stranglethorn Vale (43-45)"] = {
		...
		{ids="338", cond_if=[[((itemcount(2756) >= 1) and (itemcount(2757) >= 1) and (itemcount(2758) >= 1) and (itemcount(2759) >= 1) and (not completedq(338))) ]]},
		{ids="342", cond_if=[[((itemcount(2749) >= 1) and (itemcount(2750) >= 1) and (itemcount(2751) >= 1) and (not completedq(342))) ]]},
		{ids="603,610,600,621,209,587,604,611,617,609,628,576,594,630,608,197,193"},
	},
	["LEVELING\\Classic (12-58)\\Redridge Mountains (27-28)"] = {
		{ids="34,20,219,128,91,180"},
	},
	["LEVELING\\Boosted Characters\\Boosted Druid Intro"] = {
		{ids="64028,64031,64034,64035,64038"},
	},
	["LEVELING\\Cenarion Field Duty Logistics Assignments"] = {
		{ids="8541,8805", cond_if=[[haveanyquest(8541,8805) ]]},
		{ids="8779", cond_if=[[havequest(8779) ]]},
		{ids="8781,8780", cond_if=[[haveanyquest(8781,8780) ]]},
		{ids="8778", cond_if=[[havequest(8778) ]]},
		{ids="8496", cond_if=[[havequest(8496) ]]},
		{ids="8783", cond_if=[[havequest(8783) ]]},
		{ids="8829", cond_if=[[havequest(8829) ]]},
		{ids="8782", cond_if=[[havequest(8782) ]]},
		{ids="8497", cond_if=[[havequest(8497) ]]},
		{ids="8507"},
	},
	["LEVELING\\Classic (12-58)\\Hillsbrad Foothills (37-37)"] = {
		{ids="511,505,510,555,500,512"},
	},
	["LEVELING\\Classic (12-58)\\Stranglethorn Vale (42-42)"] = {
		{ids="340", cond_if=[[((itemcount(2734) >= 1) and (itemcount(2735) >= 1) and (itemcount(2738) >= 1) and (itemcount(2740) >= 1) and (not completedq(340))) ]]},
		{ids="341", cond_if=[[((itemcount(2742) >= 1) and (itemcount(2744) >= 1) and (itemcount(2745) >= 1) and (itemcount(2748) >= 1) and (not completedq(341))) ]]},
		...
		{ids="338", cond_if=[[((itemcount(2756) >= 1) and (itemcount(2757) >= 1) and (itemcount(2758) >= 1) and (itemcount(2759) >= 1) and (not completedq(338))) ]]},
		{ids="342", cond_if=[[((itemcount(2749) >= 1) and (itemcount(2750) >= 1) and (itemcount(2751) >= 1) and (not completedq(342))) ]]},
		{ids="1115,669,595,196,577,597,599,601,606,607"},
	},
	["LEVELING\\Classic (12-58)\\Wetlands (25-27)"] = {
		{ids="2360,2359,2607,2608", cond_if=[[Rogue ]]},
		{ids="942,288,305,294,295,299,296,463,276,277,275,943,279,484,469,464,470,306,281,284,285,289,286,471,1072,1075"},
	},
	["LEVELING\\Classic (12-58)\\Wetlands (31-31)"] = {
		{ids="290,465,292,474,472,631,632,633,634"},
	},
	["LEVELING\\Extra Zones\\Western Plaguelands"] = {
		{ids="3461,4512,5091,6028,5092,3701,5215,5216,5021,5022,5048,6182,6183,5217,6184,5050,5051,5219,5220,5222,4984,4985,5223,5225,5846,5152,5153,5154,4971,4972,5904,6004,6023,6389,5097,5533,5537,6186,4901,4986,1019,4902,6761,6762,4441,4442"},
	},
	["LEVELING\\Scepter of the Shifting Sands"] = {
	...
	["LEVELING\\Classic (12-58)\\Arathi Highlands (37-39)"] = {
		{ids="690,642,659,691,693,651,663,665,662,664,666,668,514,1112,1114,1183,1186"},
	},
	["LEVELING\\Classic (12-58)\\Felwood (57-57)"] = {
		{ids="4986,5165,8462,8461"},
	},
	["LEVELING\\Boosted Characters\\Boosted Rogue Intro"] = {
		{ids="64028,64031,64034,64035,64038"},
	},
	...
	["LEVELING\\Extra Zones\\Silithus"] = {
		{ids="1124,8275,1125,1126,8280,8277,8318,9415,8308,8281,8278,8284,8304,8285,8279,8323,8282,8287,8283,4513,5210,9128,5181,6844,6845,8320,8361,8321,8306"},
	},
	["LEVELING\\The Burning Crusade (58-70)\\Netherstorm (68-70)"] = {
		...
		{ids="10210,10211,10190,10183,10191,10342,10186,10225,10224,10263,10203,10265,10199,10173,10226,10221,10300,10262,10206,10205,10174,10334,10337,10331,10184,10305,10185,10182,10307,10306,10343,10332,10312,10316,10314,10319,10188,10239,10192,10301,10222,10240,10233,10209,10924,10223,10176,10266,10333,10433,10348,10417,10234,10418,10311,10267,10235,10423,10434,10268,10232,10237,10247,10426,10427,10317,10315,10318,10424,10336,10855,10335,10429,10430,10436,10440,10856,10435,10339,10384,10385,10405,10411,10422,10345,10270,10271,10281,10272,10437,10353,10269,10438,10273,10857,10275"},
	},
	["LEVELING\\The Burning Crusade (58-70)\\Nagrand (65-67)"] = {
		{ids="9882", cond_if=[[havequest(9882) or completedq(9882) ]]},
	...
	["LEVELING\\The Burning Crusade (58-70)\\Terokkar Forest (63-65)"] = {
		{ids="10412", cond_if=[[havequest(10412) or completedq(10412) ]]},
		{ids="10325", cond_if=[[havequest(10325) or completedq(10325) ]]},
		{ids="10021", cond_if=[[havequest(10021) or completedq(10021) ]]},
		{ids="10210,10211,10554,10553,9957,9951,9971,9968,9978,9793,10037,9979,10863,10027,10016,9992,10869,10847,10038,10040,10849,10839,10852,10896,10878,10880,10840,10842,10917,10112,10033,9986,10042,9998,10002,10007,9990,9994,10028,10012,10022,10444,9996,10446,10005,10848,10887,10881,10922,10913,10030,10227,10920,10873,10914,10877,10915,10861,10031,10228"},
	},
	["LEVELING\\Extra Zones\\Westfall"] = {
		{ids="6181,6281,6261,6285", cond_if=[[Human ]]},
	...
	["LEVELING\\Classic (12-58)\\Feralas (48-49)"] = {
		{ids="7735", cond_if=[[havequest(7735) or completedq(7735) ]]},
		{ids="3661,2944,2943,7003,7721,2879,2844,2845,7725,2942,7733"},
	},
	["LEVELING\\Boosted Characters\\Boosted Priest Intro"] = {
		{ids="64028,64031,64034,64035,64038"},
	},
	["LEVELING\\Starter Guides (1-12)\\Teldrassil (1-12) [Night Elf Starter]"] = {
		...
		{ids="456,458,459,4495,916,457,3519,917,920,3521,3522,921,488,2159,928,475,489,476,2438,929,997,918,919,2459,2541,2561,483,932,487,930,933,937,7383,931,486,922,935,940,2519,938,923,2518,2520,2498,2499"},
	},
	["LEVELING\\Ahn'Qiraj Gear\\Ruins of Ahn'Qiraj Cloak Quest"] = {
		{ids="8557", cond=[[Warrior]]},
		{ids="8695", cond=[[Paladin]]},
	...
	["LEVELING\\Classic (12-58)\\Hillsbrad Foothills (31-32)"] = {
		{ids="536,559,560,561,562,9435,564,681,293,563"},
	},
	["LEVELING\\Starter Guides (1-12)\\Dun Morogh (1-12) [Dwarf & Gnome Starter]"] = {
	...
	["LEVELING\\Classic (12-58)\\Felwood (52-53)"] = {
		{ids="8460,5155,4421,5156,4101,5157,939,4906"},
	},
	["LEVELING\\Cenarion Field Duty Combat Assignments"] = {
		{ids="8776", cond_if=[[havequest(8776) ]]},
		{ids="8502", cond_if=[[havequest(8502) ]]},
		{ids="8501", cond_if=[[havequest(8501) ]]},
		{ids="8770", cond_if=[[havequest(8770) ]]},
		{ids="8771", cond_if=[[havequest(8771) ]]},
		{ids="8687", cond_if=[[havequest(8687) ]]},
		{ids="8775", cond_if=[[havequest(8775) ]]},
		{ids="8772", cond_if=[[havequest(8772) ]]},
		{ids="8777", cond_if=[[havequest(8777) ]]},
		{ids="8774", cond_if=[[havequest(8774) ]]},
		{ids="8773", cond_if=[[havequest(8773) ]]},
		{ids="8539", cond_if=[[havequest(8539) ]]},
		{ids="8507"},
	},
	["LEVELING\\Ahn'Qiraj Gear\\Temple of Ahn'Qiraj Legs Quest"] = {
		{ids="8560", cond=[[Warrior]]},
	...
	["LEVELING\\Extra Zones\\Bloodmyst Isle"] = {
		{ids="9667", cond_if=[[havequest(9667) or completedq(9667) ]]},
		{ids="9603,9604,9605,9606", cond_if=[[Draenei ]]},
		{ids="9625,9663,9693,9624,9634,9666,9576,9629,9668,9581,9641,9648,9620,9628,9567,9594,9574,9584,9694,9643,9580,10063,9548,9549,9569,9585,9646,9779,9696,9647,9550,9687,9688,9672,9674,9682,9683,9649,9557,9698,9699,9561,9700,9578,9579,9703,9706,10064,10066,10065,9670,9669,9748,9711,9753,9756,9760,10067,9741,9746,9740,9632,9633"},
	},
	["LEVELING\\Hunter Class Quests"] = {
		{ids="6063,6101,6102,6103", cond_if=[[NightElf Hunter ]]},
		{ids="6064,6084,6085,6086", cond_if=[[Dwarf Hunter ]]},
	...
	["LEVELING\\Classic (12-58)\\Un'Goro Crater (53-55)"] = {
		...
		{ids="162,3378,4493,3444,4243,4244,4245,4289,4290,3844,4291,4503,4141,4501,3882,3883,3881,3884,4284,3845,4492,4491,4301,4292,974,4285,4287,4288,4321,4504,4496,4502,5158,5159,4441,4442,3790,3764,3781"},
	},
	["LEVELING\\Classic (12-58)\\Blasted Lands (51-52)"] = {
		{ids="3501", cond_if=[[havequest(3501) or completedq(3501) ]]},
		{ids="2783,2801,2601,2603,2581,2583,2585"},
	},
	["LEVELING\\Classic (12-58)\\Thousand Needles (33-34)"] = {
		{ids="1100,1179,1110,1104,1105,1176,1175"},
	},
	["LEVELING\\Classic (12-58)\\Dustwallow Marsh (39-42)"] = {
		{ids="1260,1302,1282,11126,11128,11133,11191,11192,11193,11134,11194,11209,11210,11198,11136,11177,1218,11180,11181,11183,11146,11123,11214,1204,1222,1219,1220,1284,1252,1253,1259,1285,1319,1320,11137,1206,11138,11139,11140,1203,1177,1286,11184,11158,1287,11141,11142,11143,11145,11147,11144,11148,11217,11160,11161,11212,11149,11172,11174,11207,11156,11150,11173,11185,11159,11208,11162,11151,11152"},
	},
	["LEVELING\\Starter Guides (1-12)\\Elwynn Forest (1-13) [Human Starter]"] = {
	...
	["LEVELING\\Classic (12-58)\\Swamp of Sorrows (45-45)"] = {
		{ids="624,9610,1392,1395,1448"},
	},
	["LEVELING\\Classic (12-58)\\Stranglethorn Vale (35-37)"] = {
		{ids="340,340", cond_if=[[((itemcount(2734) >= 1) and (itemcount(2735) >= 1) and (itemcount(2738) >= 1) and (itemcount(2740) >= 1) and (not completedq(340))) ]]},
		{ids="341,341", cond_if=[[((itemcount(2742) >= 1) and (itemcount(2744) >= 1) and (itemcount(2745) >= 1) and (itemcount(2748) >= 1) and (not completedq(341))) ]]},
		{ids="339,339", cond_if=[[((itemcount(2725) >= 1) and (itemcount(2728) >= 1) and (itemcount(2730) >= 1) and (itemcount(2732) >= 1) and (not completedq(339))) ]]},
		{ids="338,338", cond_if=[[((itemcount(2756) >= 1) and (itemcount(2757) >= 1) and (itemcount(2758) >= 1) and (itemcount(2759) >= 1) and (not completedq(338))) ]]},
		{ids="342,342", cond_if=[[((itemcount(2749) >= 1) and (itemcount(2750) >= 1) and (itemcount(2751) >= 1) and (not completedq(342))) ]]},
		{ids="1178,1111,1180,1181,622,198,215,200,203,204,328,329,574,330,331,195,5762,187,192,188,605,201,189,213,1182,578,575"},
	},
	["LEVELING\\Classic (12-58)\\Feralas (46-47)"] = {
		{ids="4124,2866,2867,3130,2869,4125,4127,2870,2871,4129,4130,2969,2970,4131,4135,2821,2982,4265,4266,2939,2940,4267,2972,3022,4281,2941"},
	},
	["LEVELING\\Cenarion Field Duty Tactical Assignments"] = {
		{ids="8737,8536", cond_if=[[haveanyquest(8737,8536) ]]},
		{ids="8534,8738,8740", cond_if=[[haveanyquest(8534,8738,8740) ]]},
		{ids="8739", cond_if=[[havequest(8739) ]]},
		{ids="8538,8498", cond_if=[[haveanyquest(8538,8498) ]]},
		{ids="8537,8535", cond_if=[[haveanyquest(8537,8535) ]]},
		{ids="8507"},
	},
	["LEVELING\\Classic (12-58)\\Redridge Mountains (18-20)"] = {
		{ids="1717,1716,1738,1739", cond_if=[[Warlock ]]},
		{ids="244,125,3741,127,129,130,92,131,150,89,246"},
	},
	["DUNGEONS\\Classic\\The Deadmines Quests"] = {
	...
	["DUNGEONS\\The Burning Crusade\\Shadow Labyrinth Quests"] = {
		{ids="10641,10668,10669,10646,10623,10626,10662,10664,11216,9824,9825,9826,9829,10177,10178,10094,10666,10091,10095,9831,10649"},
		{ids="10587,10637,10640", cond_if=[[rep ('The Aldor') >= Neutral ]]},
	...
	["DUNGEONS\\Classic\\Wailing Caverns Quests"] = {
		{ids="3366", cond_if=[[havequest(3366) or completedq(3366) ]]},
		{ids="6981", cond_if=[[havequest(6981) or completedq(6981) ]]},
	...
	["DUNGEONS\\Classic\\Raid Attunements\\Naxxramas Attunement"] = {
		{ids="9123", cond_if=[[havequest(9123) or completedq(9123) ]]},
		{ids="9122", cond_if=[[havequest(9122) or completedq(9122) ]]},
		{ids="9121", cond_if=[[havequest(9121) or completedq(9121) ]]},
	},
	["DUNGEONS\\Classic\\Raid Attunements\\Onyxia's Lair Attunement"] = {
		{ids="4182,4183,4184,4185,4186,4223,4224,4241,4242,4264,4282,4322,6402,6403,6501,6502"},
	},
...
ZGV.Quest_Cache_Accept_Horde = {
	["LEVELING\\Classic (12-58)\\Desolace (32-34)"] = {
		{ids="1146,1431,1432,9534,2,9535,247,5561,1365,1368,5386,1433,1434,1435,1366,1370,5763,5381,6143,6142,6161,5741,1480,1481,5501,1436,1482,6027,1484"},
	},
	["LEVELING\\Ahn'Qiraj Gear\\Ruins of Ahn'Qiraj Ring Quest"] = {
		{ids="8556", cond=[[Warrior]]},
		{ids="8703", cond=[[Paladin]]},
	...
	["LEVELING\\Classic (12-58)\\Badlands (41-42)"] = {
		{ids="705,703,1108,1137,710,713,714,715,711,1419,1420,2258,712,734,777,716,778"},
	},
	...
	["LEVELING\\The Burning Crusade (58-70)\\Hellfire Peninsula (58-61)"] = {
		...
		{ids="9407,10120,10289,10291,10121,10450,10086,10123,10087,10449,10124,10208,10242,10129,10162,10388,10278,10220,10538,9345,10809,10792,10213,10835,10813,10390,10864,10393,10391,10392,10236,9373,10238,10629,10630,10389,9400,10229,10161,9349,10230,9351,9361,9356,10294,10250,10258,9401,9374,9387,9366,9396,9381,9397,10442,9340,9405,9410,9406,10286,9370,9391,9438,9441,9442,9418,9375,9376,10287,9372,10159,9912,10255,10403,10367,10368,10369,9447,9472"},
	},
	...
	["LEVELING\\Mage Class Quests"] = {
		{ids="1883,1884,1959,1960,1921,1962,1943,1944,1945,1946,1947,1949,1950,1951,1952,1953,1954,1955,1956,1957,1958,2861,2846,7463", cond_if=[[Mage ]]},
	},
	...
	["LEVELING\\Classic (12-58)\\Dustwallow Marsh (38-39)"] = {
		{ids="1201,11213,1322,11225,1177,1218,11180,1238,1206,11181,11183,1270,1202,1323,1203,1239,1240,11215,11173,11156,11172,11186,11174,11207,11208"},
	},
	["LEVELING\\Ahn'Qiraj Gear\\Ruins of Ahn'Qiraj Cloak Quest"] = {
		{ids="8557", cond=[[Warrior]]},
		{ids="8695", cond=[[Paladin]]},
	...
	["LEVELING\\The Burning Crusade (58-70)\\Nagrand (65-67)"] = {
		{ids="9882", cond_if=[[rep ('The Consortium') < Friendly ]]},
		{ids="10210,10211,10551,10552,9797,9854,9789,9857,9861,9855,9850,9858,10479,9935,9939,9888,9870,9863,9864,9867,9944,9913,9862,9800,9815,9818,9819,9821,9872,9849,9804,9805,10109,9889,9890,9891,9906,9910,9916,9907,9810,10107,9983,9865,9945,9948,9866,9991,9900,9925,9914,9928,9927,9931,9932,9934,9962,9967,9970,9972,9973,9977"},
	},
	...
	["LEVELING\\The Burning Crusade (58-70)\\Zangarmarsh (61-63)"] = {
		{ids="9957", cond_if=[[(rep('Cenarion Expedition') >= Friendly) and not completedq(9968) ]]},
		{ids="9697", cond_if=[[(rep('Cenarion Expedition') >= Friendly) and not completedq(9709) ]]},
		{ids="9747,9802,9895,9716,9778,9728,9774,9796,9770,9769,9773,9752,9788,10096,9894,9718,9720,9771,9775,9899,9772,9828,9731,9785,9898,9846,9845,9814,9820,10117,9841,9911,9701,9739,9743,9919,9702,9708,9816,9903,9904,9847,9822,9709,9808,9806,9842,9823,10118,10105,9724,9732"},
	},
	...
	["LEVELING\\Classic (12-58)\\Feralas (49-49)"] = {
		...
		{ids="3380,7734,3062,3063,4120,7003,7721,7725"},
	},
	["LEVELING\\Classic (12-58)\\Stonetalon Mountains (20-21)"] = {
		{ids="1058,6542,6461,6284,1093,1094,6421,6562,1068"},
	},
	["LEVELING\\The Burning Crusade (58-70)\\Blade's Edge Mountains (67-68)"] = {
	...
	["LEVELING\\Cenarion Field Duty Logistics Assignments"] = {
		{ids="8787", cond_if=[[itemcount(21264) >= 1 or havequest(8787) ]]},
		{ids="8807", cond_if=[[itemcount(21382) >= 1 or havequest(8807) ]]},
		{ids="8810", cond_if=[[itemcount(21385) >= 1 or havequest(8810) ]]},
		{ids="8806", cond_if=[[itemcount(21380) >= 1 or havequest(8806) ]]},
		{ids="8809", cond_if=[[itemcount(21381) >= 1 or havequest(8809) ]]},
		{ids="8808", cond_if=[[itemcount(21384) >= 1 or havequest(8808) ]]},
		{ids="8785", cond_if=[[itemcount(21258) >= 1 or havequest(8785) ]]},
		{ids="8804", cond_if=[[itemcount(21378) >= 1 or havequest(8804) ]]},
		{ids="8829", cond_if=[[itemcount(21514) >= 1 or havequest(8829) ]]},
		{ids="8805", cond_if=[[itemcount(21379) >= 1 or havequest(8805) ]]},
		{ids="8786", cond_if=[[itemcount(21261) >= 1 or havequest(8786) ]]},
		{ids="8731,8732"},
	},
	...
	["LEVELING\\Druid Class Quests"] = {
		{ids="5926,5922,5930,5932,6002", cond_if=[[Tauren Druid ]]},
		{ids="6126,6127,6128,6129,6130,26,28,30,31,9063,9052,9051,9053", cond_if=[[Druid ]]},
	},
	["LEVELING\\Boosted Characters\\Boosted Priest Intro"] = {
		{ids="64046,64048,64050,64052,64063,9407"},
	},
	...
	["LEVELING\\Warlock Class Quests"] = {
		...
		{ids="1507,1508,1509,1510,1511,1515,1512,1513,2996,1801,1803,1805,1471,3631,4490,7601,7602,8420,8421,8422,7603,7562,7563,7564,7623,7626,7627,7628,7630,7624,7625,7629,7631", cond_if=[[Warlock ]]},
	},
	...
	["LEVELING\\Classic (12-58)\\Feralas (45-46)"] = {
		{ids="2973,2975,2987,2862,2822,3121,2978,2863,2974,2980,2979,2902,2903,7730,7731,2976,7732,3002,649,650,3504,3122,7541"},
	},
	["LEVELING\\Classic (12-58)\\Thousand Needles (38-38)"] = {
		{ids="1205,1147,1114,1106,1115,1186,1187,1148,1184"},
	},
	["LEVELING\\Classic (12-58)\\Stranglethorn Vale (42-43)"] = {
		...
		{ids="338,339", cond_if=[[((itemcount(2725) >= 1) and (itemcount(2728) >= 1) and (itemcount(2730) >= 1) and (itemcount(2732) >= 1) and (not completedq(339))) ]]},
		{ids="338,342", cond_if=[[((itemcount(2749) >= 1) and (itemcount(2750) >= 1) and (itemcount(2751) >= 1) and (not completedq(342))) ]]},
		{ids="587,600,621,617,609,576,1117,2864,2872"},
	},
	...
	["LEVELING\\Classic (12-58)\\Ashenvale (25-26)"] = {
		...
		{ids="6641,25,6503,6544,1918,23,824,6441,24,216,6462,6482"},
	},
	...
	["DUNGEONS\\The Burning Crusade\\Shadow Labyrinth Quests"] = {
		...
		{ids="10587,10637,10640", cond_if=[[rep ('The Aldor') >= Neutral ]]},
		{ids="10688,10689", cond_if=[[rep('The Scryers') >= Neutral ]]},
		{ids="10641,10668,10669,10646,10649,10623,10627,10663,10664,10666,11216,9824,9825,9826,9829,9831,10177,10094,10178,10091,10095"},
	},
	["DUNGEONS\\The Burning Crusade\\The Cipher of Damnation"] = {
	...
	["DUNGEONS\\The Burning Crusade\\The Mechanar Quests"] = {
		{ids="10623,10626,10663,10664,10665"},
	},
	["DUNGEONS\\The Burning Crusade\\Auchenai Crypts Quests"] = {
	...
	["DUNGEONS\\The Burning Crusade\\Karazhan Attunement"] = {
		{ids="11216,9824,9825,9826,9829,9831,9832,9836,9837,9838,9840"},
	},
	["DUNGEONS\\The Burning Crusade\\Blood Furnace Quests"] = {
		{ids="9608,9590"},
	},
...
ZGV.Quest_Cache_Turnin_Horde = {
	...
	["LEVELING\\Classic (12-58)\\Azshara (54-55)"] = {
		{ids="3505,3601,5534,3506,4300,3507"},
	},
	["LEVELING\\Classic (12-58)\\Stonetalon Mountains (23-24)"] = {
	...
	["LEVELING\\Classic (12-58)\\Badlands (41-42)"] = {
		{ids="705,1106,1108,713,714,715,710,1418,711,712,734,716,777,778,2258,1419,703,1420"},
	},
	["LEVELING\\Classic (12-58)\\Stranglethorn Vale (39-39)"] = {
		{ids="340", cond_if=[[((itemcount(2734) >= 1) and (itemcount(2735) >= 1) and (itemcount(2738) >= 1) and (itemcount(2740) >= 1) and (not completedq(340))) ]]},
		{ids="341", cond_if=[[((itemcount(2742) >= 1) and (itemcount(2744) >= 1) and (itemcount(2745) >= 1) and (itemcount(2748) >= 1) and (not completedq(341))) ]]},
	...
	["LEVELING\\Starter Guides (1-12)\\Eversong Woods (1-13) [Blood Elf Starter]"] = {
		{ids="8346", cond_if=[[havequest(8346) or completedq(8346) ]]},
		{ids="8564,10072", cond_if=[[BloodElf Priest ]]},
		{ids="9676,10069,9678,9681,64319,9684,63866,9685", cond_if=[[BloodElf Paladin ]]},
		{ids="8338", cond_if=[[havequest(8338) or completedq(8338) ]]},
		{ids="8328,10068", cond_if=[[BloodElf Mage ]]},
		{ids="8336", cond_if=[[havequest(8336) or completedq(8336) ]]},
	...
	["LEVELING\\Mage Class Quests"] = {
		{ids="1883,1884,1959,1960,1921,1943,1944,1945,1947,1949,1950,1951,1952,1953,1954,1955,1956,1957,2861,2846,7463", cond_if=[[Mage ]]},
	},
	["LEVELING\\Classic (12-58)\\Burning Steppes (54-54)"] = {
	...
	["LEVELING\\The Burning Crusade (58-70)\\Shadowmoon Valley (70-70)"] = {
		...
		{ids="10824", cond_if=[[rep('The Scryers')>=Neutral ]]},
		{ids="10210,10211,10595,10596,10597,10598,10681,10458,10599,10600,10601,10602,10624,10660,10702,10760,10625,10603,10604,10623,10761,10777,10480,10633,10804,10635,10778,10780,10481,10782,10808"},
	},
	["LEVELING\\Classic (12-58)\\Swamp of Sorrows (39-40)"] = {
	...
	["LEVELING\\The Burning Crusade (58-70)\\Zangarmarsh (61-63)"] = {
		{ids="9697", cond_if=[[havequest(9697) or completedq(9697) ]]},
		{ids="9912,9778,10103,9747,9802,9728,9895,9716,9752,9718,9774,9769,9773,9771,10096,9788,9894,9785,9772,9770,9828,9899,9775,9911,9743,9739,9701,9702,9814,9845,9846,9820,9708,9919,9806,9808,9903,9904,9841,9822,9847,9842,9823,10118,10117,9816,9709,9898,9720,9731,9724,9732"},
	},
	["LEVELING\\Classic (12-58)\\The Barrens (16-20)"] = {
		{ids="26,28,30,31", cond_if=[[Druid ]]},
		{ids="1507,1508,1509,1510,1511,1515,1512,1513", cond_if=[[Warlock ]]},
	...
	["LEVELING\\Classic (12-58)\\Feralas (49-49)"] = {
		{ids="7738", cond_if=[[havequest(7738) or completedq(7738) ]]},
		{ids="3122,7003,7721,7725,7734,3062,3063"},
	},
	["LEVELING\\Classic (12-58)\\Stonetalon Mountains (20-21)"] = {
		{ids="6401", cond_if=[[havequest(6401) or completedq(6401) ]]},
	...
	["LEVELING\\Extra Zones\\Western Plaguelands"] = {
		{ids="4293,4294,5094,6029,5021,5096,5228,5229,5230,5231,5232,5233,5234,4984,4985,5235,5236,5901,5050,5051,5902,6004,6023,5152,5153,5154,4971,4972,6390,5098,838,964,4987,1004,1123,4120,7492"},
	},
	["LEVELING\\Boosted Characters\\Boosted Rogue Intro"] = {
		{ids="64046,64048,64050,64052,64063"},
	},
	...
	["LEVELING\\The Burning Crusade (58-70)\\Terokkar Forest (63-65)"] = {
		...
		{ids="10325", cond_if=[[havequest(10325) or completedq(10325) ]]},
		{ids="10021", cond_if=[[havequest(10021) or completedq(10021) ]]},
		{ids="10210,10211,10554,10553,9957,9951,9971,9968,9978,9796,10105,10037,9979,10862,9993,10201,10018,10027,10868,10847,10039,10041,10849,10839,10852,10896,10878,10880,10840,10842,10917,10112,10043,10034,10000,10003,10008,9990,9987,10013,9995,10023,10791,10448,9997,10447,10006,10848,10887,10881,10922,10913,10030,10227,10920,10873,10914,10877,10915,10861,10031,10228"},
	},
	["LEVELING\\Classic (12-58)\\Winterspring (55-56)"] = {
	...
	["LEVELING\\Cenarion Field Duty Logistics Assignments"] = {
		{ids="8806,8805", cond_if=[[haveanyquest(8806,8805) ]]},
		{ids="8809", cond_if=[[havequest(8809) ]]},
		{ids="8807", cond_if=[[havequest(8807) ]]},
		{ids="8829", cond_if=[[havequest(8829) ]]},
		{ids="8786,8787", cond_if=[[haveanyquest(8786,8787) ]]},
		{ids="8785", cond_if=[[havequest(8785) ]]},
		{ids="8804", cond_if=[[havequest(8804) ]]},
		{ids="8808", cond_if=[[havequest(8808) ]]},
		{ids="8810", cond_if=[[havequest(8810) ]]},
		{ids="8507"},
	},
	["LEVELING\\Boosted Characters\\Boosted Priest Intro"] = {
		{ids="64046,64048,64050,64052,64063"},
	...
	["LEVELING\\Classic (12-58)\\Hillsbrad Foothills (29-30)"] = {
		...
		{ids="493", cond_if=[[havequest(493) or completedq(493) ]]},
	},
	["LEVELING\\Shaman Class Quests"] = {
		{ids="1516,1517,1518", cond_if=[[(Orc Shaman) or (Troll Shaman) ]]},
		{ids="1519,1520,1521", cond_if=[[Tauren Shaman ]]},
	...
	["DUNGEONS\\The Burning Crusade\\Shadow Labyrinth Quests"] = {
		{ids="10641,10668,10669,10646,10623,10627,10663,10664,11216,9824,9825,9826,9829,10177,10178,10094,10666,10091,10095,9831,10649"},
		{ids="10587,10637,10640", cond_if=[[rep ('The Aldor') >= Neutral ]]},
		{ids="10687,10688", cond_if=[[rep('The Scryers') >= Neutral ]]},
		{ids="10689", cond_if=[[rep ('The Scryers') >= Neutral ]]},
	},
