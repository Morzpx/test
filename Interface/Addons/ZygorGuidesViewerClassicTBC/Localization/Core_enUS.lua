...
If you're new to the guides, or have only started using them on this character, you can use the |cffddff00Smart Injection System|r to automatically find a proper starting spot for you. It might turn out to be far below your current level, if you skipped some useful quest chains or flight points, but the guide will catch up once you complete them.",
	...
	opt_group_notification = "Notification Center",								opt_group_notification_desc = "Manage Creature Detector, pop-ups, and other features that can be completed as you need.",
		...
		opt_n_popup_enable = "Enable notification popups",
			...
			opt_group_notify_skills = "Skill notifications:",	opt_group_notify_skills_desc = "Display a pop-up window with list of skills from trainer you can learn.",
				opt_n_popup_skills = "Notify me of unlearned Essential Skills", 
				opt_group_notify_also = "Also show me", 
				opt_n_popup_skills_optional = "Optional skills", 
				opt_n_popup_skills_future = "Future skills", 
				opt_group_notify_skills_when = "When:",
				...
				opt_n_popup_skills_dist = "I am near my class trainer.",
	...
	["stepgoal_intaxi"] = "Take taxi",
	["stepgoal_outtaxi"] = "Leave taxi",
...
--]]
	...
	['notifcenter_skill_title_default']= "New skills available",
	['notifcenter_skill_title_city']= "Entering capital city",
	['notifcenter_skill_title_distance']= "Class trainer nearby",
