...
function GuideMenu:ShowHome()
	...
	GuideMenu:SetWideSectionHeader("June 3rd 2021 | Release: 2.0.24941")
...
function GuideMenu:SearchQuest(questID)
	...
	local category
	local questtitle = ZGV.QuestDB.QuestNamesStored[questID] or ZGV.QuestDB.QuestNamesStored[questID] or C_QuestLog.GetQuestInfo(questID)
