...
local arrowskindir,arrowskinname = "ToonFlat","ToonFlat"
...
function arrow_mixin:ShowTraveling (elapsed,angle_rad,dist)
	...
	if r then self.arrow.arrspecular:SetVertexColor(r,g,b) end
	...
	if precise>0 then
		...
		self.arrow.arrspecular:SetVertexColor(r,g,b,a)
	else
