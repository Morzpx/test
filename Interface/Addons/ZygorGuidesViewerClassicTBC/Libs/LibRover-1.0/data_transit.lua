...
---------------------
	...
	--## ALLIANCE ##--
		...
		-- Moonglade to Rut'theran Village Druid fake taxi
			"Moonglade 44.19,45.33 -to- Darnassus 58.33,93.86 {mode:PORTAL} {fac:A} {title:Take hippogryph to Rut'theran Village } {cost:145} {cond:ZGV:RaceClassMatch('DRUID')}",
	...
	--## NEUTRAL ##--
		...
		-- The Dark Portal (Hellfire Peninsula)
			"Hellfire Peninsula/0 89.82,50.21 -to- Blasted Lands/0 58.66,59.56 {mode:PORTAL} {title:Enter the Dark Portal\nto Blasted Lands}",
...
-------------------------
	...
	--## ALLIANCE ##--
		...
		-- DEEPRUN TRAM (Ironforge / Stormwind City)
			...
			"Stormwind City/0 60.36,12.47 -x- Ironforge 72.90,50.27 {mode:PORTAL} {cost:500} {title_atob:Ride the Deeprun Tram to Ironforge} {title_btoa:Ride the Deeprun Tram to Stormwind}",
